...
public class SwipeButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            collapsedWidth = (int) typedArray.getDimension(R.styleable.SwipeButton_button_image_width, ViewGroup.LayoutParams.WRAP_CONTENT);
            collapsedHeight = (int) typedArray.getDimension(R.styleable.SwipeButton_button_image_height, ViewGroup.LayoutParams.WRAP_CONTENT);
            trailEnabled = typedArray.getBoolean(R.styleable.SwipeButton_button_trail_enabled, false);
            ...
            float textSize = Utils.converPixelsToSp(typedArray.getDimension(R.styleable.SwipeButton_inner_text_size, 0), context);
            if (textSize != 0) {
            ...
            if (initialState == ENABLED) {
                ...
                LayoutParams layoutParamsButton = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        return (v, event) -> {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    return !Utils.isTouchOutsideInitialPosition(event, swipeButtonInner);
    ...
    private @NonNull AnimatorSet getAnimatorSet() {
    ...
    private void setTrailingEffect() {
        if (trailEnabled) {
            ...
            layer.setLayoutParams(new RelativeLayout.LayoutParams((int) (swipeButtonInner.getX() + (float) swipeButtonInner.getWidth() / 3), centerText.getHeight()));
        }
    }
    ...
    public void setCenterTextColor(@NonNull Context context, int color) {
